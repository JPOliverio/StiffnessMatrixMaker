...
class BeamElement{
    ...
    */
    ...
    stiffnessMatrix[1][3] = -1*(pow(sin(angle),2))*stiffnessMatrix[1][3];

    stiffnessMatrix[2][0] = -1*(pow(cos(angle),2))*stiffnessMatrix[2][0];
    ...
    stiffnessMatrix[3][1] = -1*(pow(sin(angle),2))*stiffnessMatrix[3][1];
